...
$(document).on("click", "#workorder_search_btn", function() {
    var workSearchText = $("#workSearch").val();
    Dajaxice.production.workorderSearch(workorderSearchCallBack, {"workSearchText":workSearchText});
});
...
$(document).on("click", "#prodplan_search_btn", function(){
    Dajaxice.production.prodplanSearch(prodplanSearchCallBack, {"form":$("#pp_searchForm").serialize()});
});
