...
BIDFORM_PART_STATUS_INVITE_BID_APPLY_FILL=55
BIDFORM_PART_STATUS_INVITE_BID_APPLY_Q_FILL=56
BIDFORM_PART_STATUS_INVITE_BID_APPLY_OPERATOR_COMMENT=60
BIDFORM_PART_STATUS_INVITE_BID_APPLY_LEAD_COMMENT=65
BIDFORM_PART_STATUS_INVITE_BID_NEED_COMMENT=62
BIDFORM_PART_STATUS_INVITE_BID_OPERATOR_COMMENT=67
BIDFORM_PART_STATUS_INVITE_BID_NEED_TECH_COMMENT=70
BIDFORM_PART_STATUS_INVITE_BID_NEED_LEAD_COMMENT=75
BIDFORM_PART_STATUS_INVITE_BID_CENTRALIZE_COMMENT=80
BIDFORM_PART_STATUS_INVITE_BID_LOGISTICAL_COMMENT=85
BIDFORM_PART_STATUS_INVITE_BID_COMPREHENSIVE_COMMENT=90
BIDFORM_PART_STATUS_INVITE_BID_COMPANY_COMMENT=92
...
#   (BIDFORM_PART_STATUS_APPROVED,u"标单审批"),
    ...
    (BIDFORM_PART_STATUS_INVITE_BID_APPLY_FILL,u"招标申请填写"),
    (BIDFORM_PART_STATUS_INVITE_BID_APPLY_Q_FILL,u"比质比价卡填写"),
    (BIDFORM_PART_STATUS_INVITE_BID_APPLY_OPERATOR_COMMENT,u"申请经办人意见"),
    (BIDFORM_PART_STATUS_INVITE_BID_OPERATOR_COMMENT,u"经办人意见"),
    (BIDFORM_PART_STATUS_INVITE_BID_APPLY_LEAD_COMMENT,u"申请领导意见"),
    (BIDFORM_PART_STATUS_INVITE_BID_NEED_COMMENT,u"需求单位意见"),
    (BIDFORM_PART_STATUS_INVITE_BID_NEED_TECH_COMMENT,u"需求单位技术主管意见"),
    (BIDFORM_PART_STATUS_INVITE_BID_NEED_LEAD_COMMENT,u"需求单位领导意见"),
    (BIDFORM_PART_STATUS_INVITE_BID_CENTRALIZE_COMMENT,u"归口部门意见"),
    (BIDFORM_PART_STATUS_INVITE_BID_LOGISTICAL_COMMENT,u"物流采控意见"),
    (BIDFORM_PART_STATUS_INVITE_BID_COMPREHENSIVE_COMMENT,u"综合部门意见"),
    (BIDFORM_PART_STATUS_INVITE_BID_COMPANY_COMMENT,u"公司意见"),
...
COMMENT_USER_CHOICE=(
    (APPLY_OPERATOR,u"申请单位经办人"),
    (APPLY_LEAD,u"申请单位领导"),
    (NEED_TECH,u"需求单位技术主管"),
    (NEED_LEAD,u"需求单位领导"),
    (CENTRALIZE,u"归口部门"),
    (LOGISTICAL,u"物流采控"),
    (COMPREHENSIVE,u"综合部门"),
    (COMPANY,u"公司")
)
