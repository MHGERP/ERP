...
class WeldingMaterialApplyCard(models.Model):
    ...
    index=models.IntegerField(verbose_name=u'编号',blank=False)
    ...
    actual_weight=models.FloatField(verbose_name=u'实发重量',blank=False)
    actual_quantity=models.FloatField(verbose_name=u'实发数量',blank=False)
